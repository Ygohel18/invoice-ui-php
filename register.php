...
<div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
    ...
    <div class="app-auth-container">
        ...
        <div class="auth-credentials m-b-xxl">
            <label for="signUpFullname" class="form-label">Fullname</label>
            <input type="text" class="form-control m-b-md" id="signUpFullname" aria-describedby="signUpFullname"
                   placeholder="Enter name">

            <label for="signUpEmail" class="form-label">Email address</label>
            <input type="email" class="form-control m-b-md" id="signUpEmail" aria-describedby="signUpEmail"
                   placeholder="user@planckstudio.in">
