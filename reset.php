...
<div class="app app-auth-lock-screen align-content-stretch d-flex flex-wrap justify-content-end">
    ...
    <div class="app-auth-container">
        ...
        <p class="auth-description">Enter new password for your account.</p>

        <div class="auth-credentials m-b-xxl">
            <label for="signInEmail" class="form-label">Email address</label>
            <input type="email" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail"
                   placeholder="user@planckstudio.in" disabled>
        ...
        <div class="auth-submit">
            ...
            <a href="./login.php" class="auth-forgot-password float-end">Back to Login</a>
        </div>
    </div>
</div>
